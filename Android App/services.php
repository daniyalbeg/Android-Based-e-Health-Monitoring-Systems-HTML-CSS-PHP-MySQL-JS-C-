...
<html>
					...
					<div class="top-nav">
						<div class="wrap">
							<ul>
								...
								<li><a href="services.php">Doctor's Area</a></li>
	...
	<!---End-header---->
			...
			<div class="content">
				...
				<div class="about">
					<div class="about-topgrid1">
										<h3><center><a href= "pat_appointment_fetch.php">Patient's Appointment</a></center></h3>
										
										<h4><img src="images/tes.png" width="300px" height="250px"></h4>
									
									</div>
					<div class="about-histore">
									<h3><center><a href= "health_test.php">Patient's Health Data Test</a></center></h3>
										<h4><img src="images/hearts.png" width="350px" height="230px"></h4>
					...
					<div class="about-services">
									<h3><center><a href= "pat_prescription.php">Send Prescriptions</a></center></h3>
										<h4><img src="images/3.JPG" width="360px" height="270px"></h4>
									<p></p>
									
								</div>
								<div class="about-services">
									<h3><center><a href= "doc_symptoms_fetch.php">Check Patient's Symptoms</a></center></h3>
										<h4><img src="images/sim.jpg" width="300px" height="240px"></h4>
									<p></p>
		...
		<h1 align='right'><a href='plogout.php'>Logout</a></h1>	
	<!---End-wrap---->
		<!---start-footer---->

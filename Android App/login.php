...
<form method='post' action='login.php'>
	...
	<tr>
		<td colspan='5'align='center'><center><img src="images/d.png" style="width:150px;height:150px"</center><h1>Doctor's Login</h1></td>
	</tr>
	
	<tr>
		<td>Username:</td>
		<td><input type='text' name='name' placeholder="Sheema" maxlength="50" size="30"/></td>
	</tr>
...
</font> <a href='drecord.php'><br><br>Sign Up </br></br></a></font>
</center>
</body>	
</html>
<?php
...
if(isset($_POST['login']))
{
	...
	$check_user = "select * from doctor where doctor_pass='$password' AND doctor_email='$email'";
	...
	echo 
	"<script>window.open('services.php','_self')</script>";
	}
	else{

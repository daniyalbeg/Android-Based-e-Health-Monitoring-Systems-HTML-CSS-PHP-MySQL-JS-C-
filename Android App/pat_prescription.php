...
<body>
<form method='post' action='pat_prescription.php'>
	...
	<tr>
		...
		<td><input type='text' name='diagnose' placeholder="Diagnose" maxlength="50" size="30"/></td>
	</tr>
	<tr>
		<td>Medicine1:</td>
		<td><input type='text' name='med1' placeholder="medicine" maxlength="50" size="30"/></td>
		<td>Syrup1:</td>
		<td><input type='text' name='syrup1' placeholder="medicine" maxlength="50" size="30"/></td>
	</tr>
	
	<tr>
		<td>Medicine2:</td>
		<td><input type='text' name='med2' placeholder="medicine" maxlength="50" size="30"/></td>
		<td>Syrup2:</td>
		<td><input type='text' name='syrup2' placeholder="syrup" maxlength="50" size="30"/></td>
	</tr>
	<tr>
		<td>Medicine3:</td>
		<td><input type='text' name='med3' placeholder="medicine" maxlength="50" size="30"/></td>
		<td>Syrup3:</td>
		<td><input type='text' name='syrup3' placeholder="syrup" maxlength="50" size="30"/></td>
	</tr>
	
	<tr>

	<td><label for="d-select">Date </label></td>
    <td>
...
<option value="M">Month</option>
	...
	<tr>
		<td>Quantity:</td>
		<td><input type='text' name='quantity' placeholder="Quantity" maxlength="50" size="20"/></td>
	
		<td>Test:</td>
		<td><input type='text' name='test' placeholder="Test" maxlength="50" size="30"/></td>
		</tr>
	</tr>
  ...
  <td><textarea  name="comments" maxlength="1000"  rows="7" cols="24"></textarea>
	...
	<tr>
		...
		<td><input type='submit' name='submit' value='Send Prescription'/></td>
	</tr>
	</table>
	</tbody>
</form>
...
$check_Id = "select * from prescription where patient_id='$patient_id'";
	...
	$query = "insert into prescription (patient_id,doctor_id,patient_diagnose,med1,med2,med3,syrup1,syrup2,syrup3,dosage,patient_age,test,quantity,comments,usage_period) values ('$patient_id','$doctor_id','$patient_diagnose','$med1','$med2','$med3','$syrup1','$syrup2','$syrup3','$dosage','$patient_age','$test','$quantity','$comments','$usage_period')";

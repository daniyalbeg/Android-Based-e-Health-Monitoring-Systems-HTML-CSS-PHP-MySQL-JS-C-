						...
						<ul>
							...
							<li><a href="login.php">Doctor's Area</a></li>
								<li><a href="plogin.php">Patient's Area</a></li>
									<li><a href="cnews.php">Admin Area</a></li>
			...
			<div class="content">
				...
				<div class="about">
					<div class="about-topgrid1">
										<h3><center><a href= "adm_appointment_fetch.php">Patient's Appointment List</a></center></h3>
										
										<h4><img src="images/appoint.png" width="310px" height="200px"></h4>
									
									</div>
					<div class="about-histore">
									<h3><center><a href= "pinews.php">Patient's Record List</a></center></h3>
										<h4><img src="images/ss.png" width="270px" height="230px"></h4>
					...
					<div class="about-services">
									<h3><center><a href= "docnews.php">Doctor's Record List</a></center></h3>
										<h4><img src="images/doct.png" width="280px" height="210px"></h4>
									<p></p>
									
								</div>
								<div class="about-services">
									<h3><center><a href= "pat_symptoms.php">Payments</a></center></h3>
										<h4><img src="images/512.gif" width="380px" height="280px"></h4>
									<p></p>

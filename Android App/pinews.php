...
<html>
					...
					<div class="top-header">
						...
						<div class="right-left">
							<ul>
								...
								<li class="sign"><a href="record.php">Doctor's Sign up</a></li>
  ...
  <center><h3>Patient's Record</h3></center>
  <center>
...
?>	
	...
	<td><a href='pat_record.php '>Check Details</td></a>
	<td><a href='pinews_delete.php?del=<?php echo $patient_Id;?>'> Delete</a></td>
	</tr>
<?php 
}
?>

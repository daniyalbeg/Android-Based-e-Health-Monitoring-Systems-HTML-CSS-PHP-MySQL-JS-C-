...
<html>
  ...
  <center><h3>Patient's Personal Record</h3></center>
<center>
...
?>	
	...
	<td><?php echo $patient_add; ?></td>
	<td><?php echo $patient_cell; ?></td>
	<td><?php echo $patient_age; ?></td>
	<td><?php echo $patient_sex; ?></td>
	<td><?php echo $patient_city; ?></td>
	<td><?php echo $patient_country; ?></td>
	<td><?php echo $patient_bg; ?></td>
	<td><?php echo $patient_date; ?></td>
	<td><?php echo $patient_month; ?></td>
	<td><?php echo $patient_year; ?></td>
	
	<td><a href='adinews_delete.php?del=<?php echo $patient_id;?>'> Delete</a></td>

			...
			<div class="content">
				...
				<div class="about">
					<div class="about-topgrid1">
										<h3><center><a href= "adinews.php">Patient's Personal Information</a></center></h3>
										
										<h4><img src="images/emr.png" width="300px" height="250px"></h4>
									
									</div>
					<div class="about-histore">
									<h3><center><a href= "health_test.php">Patient's Health Data Test</a></center></h3>
										<h4><img src="images/he.png" width="300px" height="250px"></h4>
					...
					<div class="about-services">
									<h3><center><a href= "adm_symptoms_fetch.php">Patient's Symptoms</a></center></h3>
										<h4><img src="images/ree.jpg" width="300px" height="240px"></h4>
									<p></p>
									
								</div>
								<div class="about-services">
									<h3><center><a href= "adm_check_prescription.php">Doctor's Prescription</a></center></h3>
										<h4><img src="images/cal.png" width="300px" height="240px"></h4>
									<p></p>
